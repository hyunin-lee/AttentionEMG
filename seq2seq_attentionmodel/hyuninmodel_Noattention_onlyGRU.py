...
if __name__=="__main__":
    ...
    test_path = '/home/hyuninlee/PycharmProjects/xcorps/seq2seq_attentionmodel/testData/lhi'
    save_path = '/home/hyuninlee/PycharmProjects/xcorps/seq2seq_attentionmodel/result/NoAttentionOnlyGRU/'
    model_path = '/home/hyuninlee/PycharmProjects/xcorps/seq2seq_attentionmodel/result/NoAttentionOnlyGRU/'
    ...
    parser.add_argument('--train_iter','-ti' ,type=int, default=50)
    ...
    attn_decoder1 = DecoderRNN(hidden_size, N_fingerAngle, dropout_p=0.1).to(device)
